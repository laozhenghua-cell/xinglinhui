<template>
  <div class="patient-detail" v-loading="loading">
    <el-page-header @back="$router.push('/patients')" title="返回患者列表">
      <template #content>
      ...
      <el-col :xs="24" :lg="8">
        <el-card class="info-card">
          ...
          <div class="action-buttons">
            <el-button type="success" @click="$router.push(`/consultations/new?patient_id=${patient.id}`)">
        ...
        <el-card>
          ...
          <el-timeline v-if="consultations.length > 0">
            <el-timeline-item
              ...
              placement="top"
            >
              <el-card shadow="hover" class="consultation-card" @click="$router.push(`/consultations/${item.id}`)">
