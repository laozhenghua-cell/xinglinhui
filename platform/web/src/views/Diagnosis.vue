        ...
        <el-col :xs="24" :lg="10">
          <div class="result-sticky">
            <div style="margin-bottom:8px">
              <el-link type="primary" :href="'/kb/search?q=' + encodeURIComponent((syndromeResult && (syndromeResult.primary_syndrome_name || syndromeResult.disease_type)) || '痔瘘')" target="_blank">
                在杏林汇总库检索相关方剂/医案 →
              </el-link>
            </div>
            <SyndromeResult
