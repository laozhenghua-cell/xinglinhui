  ...
  <div class="xl-page">
    ...
    <div class="xl-card" style="margin-bottom:14px">
      ...
      <div class="quick-grid">
        ...
        <div class="quick" @click="router.push('/dx')"><span class="q-ico">🔮</span><b>病种辨证</b><i>疮疡 · 痔漏 · 儿科 · 丹药专科辨证</i></div>
        <div class="quick" @click="router.push('/systems')"><span class="q-ico">🧭</span><b>六体系辨证</b><i>八纲 · 六经 · 卫气营血 · 脏腑 · 三焦 · 经络</i></div>
