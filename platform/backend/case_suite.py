...
CASES = [
    ...
    {"id": "T03", "name": "肝火犯胃吞酸(左金丸)", "detail": "主诉:胁痛口苦;另外吞酸嘈杂", "labels": ["胁痛", "口苦", "吞酸", "嘈杂"],
     "chief_contains": "胁痛口苦", "formula": "左金丸", "zhice": ""},
    {"id": "T06", "name": "湿热下注带下(易黄汤)", "detail": "主诉:带下黄稠腥臭;另外口苦苔黄腻", "labels": ["带下黄稠", "带下", "口苦", "苔黄腻"],
     "chief_contains": "", "formula": "易黄汤", "zhice": ""},
    # ===== JK 《医宗金鉴·杂病心法要诀》医案 =====
    {"id": "JK01", "name": "金鉴·风寒咳嗽(杏苏散)", "detail": "主诉:咳嗽痰稀白恶寒无汗", "labels": ["咳嗽", "痰稀白", "恶寒", "无汗", "鼻塞"],
     "chief_contains": "", "formula": "杏苏散", "zhice": ""},
    {"id": "JK04", "name": "金鉴·阴虚咳嗽(麦味地黄丸)", "detail": "主诉:干咳痰少而黏潮热盗汗", "labels": ["干咳", "痰少而黏", "潮热", "盗汗"],
     "chief_contains": "", "formula": "麦味地黄丸", "zhice": ""},
    {"id": "JK05", "name": "金鉴·肝阳眩晕(天麻钩藤饮)", "detail": "主诉:眩晕头目胀痛面红目赤", "labels": ["眩晕", "头目胀痛", "面红目赤", "急躁易怒"],
     "chief_contains": "", "formula": "天麻钩藤饮", "zhice": ""},
    {"id": "JK08", "name": "金鉴·风寒头痛(川芎茶调散)", "detail": "主诉:头痛恶寒无汗流清涕", "labels": ["头痛", "恶寒", "无汗", "流清涕"],
     "chief_contains": "", "formula": "川芎茶调散", "zhice": ""},
    {"id": "JK11", "name": "金鉴·石淋(石韦散)", "detail": "主诉:尿痛小便涩痛尿血", "labels": ["尿痛", "小便涩痛", "尿血"],
     "chief_contains": "", "formula": "石韦散", "zhice": ""},
    {"id": "JK12", "name": "金鉴·痛痹(乌头汤)", "detail": "主诉:关节疼痛遇寒加重痛有定处", "labels": ["关节疼痛", "遇寒加重", "痛有定处", "畏寒肢冷"],
     "chief_contains": "", "formula": "乌头汤", "zhice": ""},
    {"id": "JK13", "name": "金鉴·热痹(宣痹汤)", "detail": "主诉:关节红肿热痛发热口渴", "labels": ["关节红肿热痛", "发热", "口渴", "小便短赤"],
     "chief_contains": "", "formula": "宣痹汤", "zhice": ""},
    {"id": "JK14", "name": "金鉴·气郁化火(丹栀逍遥散)", "detail": "主诉:急躁易怒口苦胁痛", "labels": ["急躁易怒", "口苦", "胁痛", "面红目赤"],
     "chief_contains": "", "formula": "丹栀逍遥散", "zhice": ""},
    {"id": "JK15", "name": "金鉴·阴黄(茵陈术附汤)", "detail": "主诉:身目发黄黄色晦暗畏寒肢冷", "labels": ["身目发黄", "黄色晦暗", "畏寒肢冷", "便溏"],
     "chief_contains": "", "formula": "茵陈术附汤", "zhice": ""},
